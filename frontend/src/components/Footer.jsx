  ...
  return (
    <footer className="mb-4">
      <div className="rounded-tr-3xl rounded-tl-3xl pt-12 xl:pt-20 pb-8">
        ...
        <p>
          Books that open minds, touch hearts, and spark imagination — all
        ...
        >
          <div className="max-w-sm">
            ...
            <p className="py-4">
              At WhimsyReads, we believe books should make you smile, dream, and
              explore the unexpected. From charming tales to curious adventures,
              our collection brings you stories that dance between reality and
              imagination.
            </p>
